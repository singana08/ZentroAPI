CREATE TABLE halulu_api.workflow_statuses (
...
CREATE UNIQUE INDEX "IX_workflow_statuses_RequestId_ProviderId" ON halulu_api.workflow_statuses ("RequestId", "ProviderId");
CREATE INDEX "IX_workflow_statuses_RequestId" ON halulu_api.workflow_statuses ("RequestId");
CREATE INDEX "IX_workflow_statuses_ProviderId" ON halulu_api.workflow_statuses ("ProviderId");